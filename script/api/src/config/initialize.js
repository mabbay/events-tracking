...
module.exports = function () {
    ...
    // this part is added to load middlewares in modules directory
    global.Middlewares.modules = {};
    fs.readdirSync('src/middlewares/modules').forEach(name => {
        name = name.split('.')[0];
        global.Middlewares['modules'][name] = require(`../middlewares/modules/${name}`);
    });
