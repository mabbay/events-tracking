...
<template>
  <div class="parentx">
    ...
    <vs-sidebar
      ...
      <div id="nav-menu" @mouseenter="mouseEnter" @mouseleave="mouseLeave">

        <!-- Header -->
        <div id="logo-storino" class="header-sidebar flex items-end justify-between relative" slot="header">
          ...
          <router-link tag="div" class="vx-logo cursor-pointer flex items-center"  to="/">
            ...
            <div class="flex flex-col relative" >
              <span class="vx-logo-text text-primary" v-show="isMouseEnter || !reduce" v-if="title">
                <span> {{ title }} </span>
                <small class="rounded-full bg-primary text-white px-2 text-xs" >
                  <span class="" > {{ 'Tracking' | t }} </span>
                </small>
              </span>
            </div>
          </router-link>
          ...
          <!-- <div style="position: absolute; top: 0; right: 0;" >
            <vs-chip color="primary"  v-show="isMouseEnter || !reduce">
              Beta
            </vs-chip>
          </div> -->
          <!-- Menu Buttons -->
        ...
        <!-- Menu Items -->
        <component :is="scrollbarTag" ref="verticalNavMenuPs" class="scroll-area-v-nav-menu pt-2 pb-base" :settings="settings" @ps-scroll-y="psSectionScroll" @scroll="psSectionScroll" :key="$vs.rtl">
