<template>
  <div class="flex">
    ...
    <unicon  @click="showFullSearch = true"  class="cursor-pointer navbar-fuzzy-search mr-4 text-secondary" name="search" fill="rgb(98 98 98)" icon-style="line"  />
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      bookmarked: this.$store.state.bookmarked,
